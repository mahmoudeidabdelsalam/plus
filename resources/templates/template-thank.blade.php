    ...
    <section>
      <div class="container">
        ...
        <div class="row justify-content-center m-5">
          ...
          <a href="" class="btn btn-primary" style="background-image:url({{ get_theme_file_uri().'/resources/assets/images' }}/bag.png); background-repeat: no-repeat; padding-left: 34px;  border: 5px solid transparent;box-sizing: border-box;">Instll Plugin</a>
          </div>
        </div>
      </div>
    </section>
